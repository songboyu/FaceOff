...
// //提交URL按钮点击事件
    ...
    $('#snap').click(function(){
        ...
        ({
            type: "POST",
            url: "http://soongboyu.eicp.net/php/upload.php",
    ...
    $('#ok').click(function(){
        ...
        ({
            type: "POST",
            url: "http://soongboyu.eicp.net/php/uploadWithFace.php",
        ...
        query.find().then(function(info) {
            ...
            galleryPullUpAction = function(){
                for (var i = 0, len = isMobile.any() == true ? 6:12; i < len; i++) 
                {
                    ...
                    var hr = $('<a class="imageShow_large" href="http://soongboyu.eicp.net/images/withFace/'+info[i].get("filename")+'" rel="external"></a>');
                    var img = document.createElement('img');
                    img.src = 'http://soongboyu.eicp.net/images/withFace/'+info[imgCount].get("filename");
                    hr.append(img);
                    li.append(hr);
                    up.append(a1);
                    down.append(a2);
            ...
            {   
                ...
                var hr = $('<a class="imageShow_large" href="http://soongboyu.eicp.net/images/withFace/'+info[i].get("filename")+'" rel="external"></a>');
                var img = document.createElement('img');
                img.src = 'http://soongboyu.eicp.net/images/withFace/'+info[i].get("filename");
                hr.append(img);
                li.append(hr);
                up.append(a1);
                down.append(a2);
        ...
        ({
            ...
            { 
                ...
                for (var i = 0, len = 10; i < len; i++) {
                    ...
                    hr.append(topImg);
                    img.src = 'http://soongboyu.eicp.net/images/withFace/'+arr[i];
                    img.width = 50;
                    img.height = 80;
                    hr.append(img);
